/**
 * @file    A_CLI_Detailed_Help_Command_Response_Handler.hpp
 * @author  Marvin Smith
 * @date    7/2/2015
*/
#ifndef __CLI_CPP_LIB_HANDLERS_A_CLI_DETAILED_HELP_COMMAND_RESPONSE_HANDLER_HPP__
#define __CLI_CPP_LIB_HANDLERS_A_CLI_DETAILED_HELP_COMMAND_RESPONSE_HANDLER_HPP__
...
/**
 * @class A_CLI_Detailed_Help_Command_Response_Handler
*/
class A_CLI_Detailed_Help_Command_Response_Handler : public CLI::A_Command_Response_Handler_Base 
{

    public:
        
        /// Pointer Type
        typedef std::shared_ptr<A_CLI_Detailed_Help_Command_Response_Handler> ptr_t;
