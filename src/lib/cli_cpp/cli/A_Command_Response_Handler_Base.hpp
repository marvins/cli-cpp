 ...
 * @date   5/19/2015
*/
#ifndef __CLI_CPP_CLI_A_COMMAND_RESPONSE_HANDLER_BASE_HPP__
#define __CLI_CPP_CLI_A_COMMAND_RESPONSE_HANDLER_BASE_HPP__
...
class A_Command_Response_Handler_Base{
    ...
    public:
        ...
        */
         ...
         */
        virtual bool Is_Supported( const CMD::A_Command_Result& command )const = 0;
