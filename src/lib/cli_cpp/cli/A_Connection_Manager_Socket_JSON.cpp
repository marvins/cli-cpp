/**
 * @file    A_Connection_Manager_Socket_JSON.cpp
 * @author  Marvin Smith
 * @date    5/9/2018
 */
...
/*      Constructor      */
/*************************/
A_Connection_Manager_Socket_JSON::A_Connection_Manager_Socket_JSON( A_Connection_Manager_Base_Config::ptr_t configuration )
    : A_Connection_Manager_Base(configuration),
      m_class_name("A_Connection_Manager_Socket")
{
    // Cast the configuration
    m_configuration = std::dynamic_pointer_cast<A_Connection_Manager_Socket_JSON_Config>(configuration);
...
/*       Destructor          */
/*****************************/
A_Connection_Manager_Socket_JSON::~A_Connection_Manager_Socket_JSON()
{
}
...
/*          Configure the SOcket            */
/********************************************/
void A_Connection_Manager_Socket_JSON::Setup_Socket()
{
...
/*       Close the socket       */
/********************************/
void A_Connection_Manager_Socket_JSON::Close_Socket()
{
    close( m_sock_fd );
}
...
/***********************************************/
void A_Connection_Manager_Socket_JSON::Run_Handler()
{
    ...
    while( m_is_running == true )
    {
        ...
        CORE::Session session( next_position,
                               CORE::ConnectionType::SOCKET_JSON );
...
/*       Refresh all Screens        */
/************************************/
void A_Connection_Manager_Socket_JSON::Refresh_Screens()
{
    BOOST_LOG_TRIVIAL(debug) << "Not Implemented for JSON Socket Manager.";
}
...
/*       Refresh the screen      */
/*********************************/
void A_Connection_Manager_Socket_JSON::Refresh_Screen( const int& instance_id )
{
    BOOST_LOG_TRIVIAL(debug) << "Not Implemented for JSON Socket Manager.";
}
...
/*************************************************/
std::vector<CORE::Session> A_Connection_Manager_Socket_JSON::Get_Active_Session_List()const
{
    // Create output list
...
/*****************************************************/
int A_Connection_Manager_Socket_JSON::Get_Next_Client_Slot()
{
